...
const storeProductContainer = document.querySelector("#wishList")

document.querySelector("#saveToWishList").addEventListener("click", () => {
    const productName = document.querySelector("#product").value
    const storeName = document.querySelector("#store").value

    storeProductContainer.innerHTML += `I can purchase ${productName} at ${storeName}.`
})